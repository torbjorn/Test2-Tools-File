...
SKIP: {
    ...
    my $events = intercept {
        ...
        file_mode_is $handy_file, 0700; ## PASS
        file_mode_is $handy_file, 0701; ## FAIL

        chmod(0644, $handy_file) or bail_out("Failed chmod tempfile for tesing");
        file_mode_is $handy_file, 0644; ## PASS
        file_mode_is $handy_file, 0645; ## FAIL

        chmod(0100, $handy_file) or bail_out("Failed chmod tempfile for tesing");
        file_mode_is $handy_file, 0100; ## PASS
        file_mode_is $handy_file, 0101; ## FAIL

        {
            local $ENV{PRETEND_TO_BE_WIN32} = 1;
            file_mode_is $handy_file, 0100; ## SKIP
        }
        ...
        file_mode_is $handy_file, 0100; ## FAIL

    };

    like $events, t2_events(qw(Pass Fail Pass Fail Pass Fail Skip Fail)), "file_mode_is: events";
