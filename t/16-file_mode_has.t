...
SKIP: {
    ...
    my $events = intercept {
        ...
        file_mode_has $handy_file, 0444; ## PASS
        file_mode_has $handy_file, 0744; ## FAIL

        chmod(0700, $handy_file) or bail_out("Failed chmod tempfile for tesing");
        file_mode_has $handy_file, 0600; ## PASS
        file_mode_has $handy_file, 0644; ## FAIL

        {
            local $ENV{PRETEND_TO_BE_WIN32} = 1;
            file_mode_has $handy_file, 0700; ## SKIP
        }
        ...
        file_mode_has $handy_file, 0700; ## FAIL

    };

    like $events, t2_events(qw(Pass Fail Pass Fail Skip Fail)), "file_mode_has: events";
